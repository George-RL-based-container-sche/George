...
from simulated_env.highlevel_env import LraClusterEnv
from simulated_env.PolicyGradient_CPO_transfer import PolicyGradient
import argparse
...
def train(params):
    ...
    while epoch_i < params['epochs']:
        ...
        tput_set.append(tput)
        vio_set_total.append(list_check_ratio)
...
def batch_data(index):
    ...
    npzfile = np.load("./data/batch_set_cpo_729node_sim_" + str(hyper_parameter['C_N']) + '.npz')
