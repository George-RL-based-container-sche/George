function [all,ratio,abs_vio] = testbed_more(Num_C_per_app, nodes, weight_cpo)
Num_apps = 7;
Dn = 1000;
Num_nodes = nodes;
Capacity = 8;
preference = table2array(readtable("./interference_applist_testbed_simple_cpo.csv"));
...
options = optimoptions('intlinprog','MaxTime',60*10,'MaxFeasiblePoints', 6);
